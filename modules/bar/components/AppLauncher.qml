...
Rectangle {
        ...
        Rectangle {
            ...
            Column {
                ...
                Rectangle {
                    ...
                    height: 28
                    radius: 4
                    color: focusMouseArea.containsMouse ? "#333333" : "transparent"
                    ...
                    MouseArea {
                        ...
                        onClicked: {
                            focusApp(appList.model.get(darkContextMenu.appIndex).processName)
    ...
    function launchApp(command, index) {
        ...
        try {
            const hostCommand = ["distrobox-host-exec", command];
